  ...
  class CallbackFunctionsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create callback_function" do
      assert_difference('CallbackFunction.count') do
        post callback_functions_url, params: { callback_function: { deleted_at: @callback_function.deleted_at, name: @callback_function.name, position: @callback_function.position } }
      end
    ...
    test "should update callback_function" do
      patch callback_function_url(@callback_function), params: { callback_function: { deleted_at: @callback_function.deleted_at, name: @callback_function.name, position: @callback_function.position } }
