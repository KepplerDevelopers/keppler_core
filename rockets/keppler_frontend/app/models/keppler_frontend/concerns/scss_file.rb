...
module KepplerFrontend
  module Concerns
    module ScssFile
      ...
      def scss_code
        File.read("#{url_front}/app/assets/stylesheets/keppler_frontend/app/#{name}.scss")
      end

      def install_scss
        out_file = File.open("#{url_front}/app/assets/stylesheets/keppler_frontend/app/#{name}.scss", "w")
