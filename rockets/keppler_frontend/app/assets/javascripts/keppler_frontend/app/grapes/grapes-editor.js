$(document).ready(function() {
 ...
 container.innerHTML = code.outerHTML;
  ...
  var editor  = grapesjs.init(
  {
    ...
    plugins: ['testplug', 'gjs-blocks-basic', 'gjs-plugin-forms', 'grapesjs-lory-slider', 'gjs-component-countdown', 'gjs-style-gradient'],
    pluginsOpts: {
      'gjs-style-gradient': {
        colorPicker: 'default',
        grapickOpts: {
    ...
    blockManager: {
      blocks: [{
          ...
          label: '1 Block',
          category: 'Basic',
          content: `<div class="row"> Hola </div>`,
          ...
          attributes: {class:'fa fa-tint'}
        },{
          id: 'contaier',
          label: 'Container',
          category: 'Bootstrap',
          content: `<div class="container"><p>Insert elements here</p></div>`,
          attributes: {class:'fa fa-tint'}
        },{
          id: 'navbar',
          label: 'Navbar',
