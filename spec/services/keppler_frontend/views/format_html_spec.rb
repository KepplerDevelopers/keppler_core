...
RSpec.describe KepplerFrontend::Views, type: :services do
  ...
  context 'install' do
    ...
    it { expect(File.exist?("#{@assets_css}/views/#{@view.name}.scss")).to eq(true) }
    it { expect(File.exist?("#{@assets_js}/views/#{@view.name}.js")).to eq(true) }
  ...
  context 'update' do
    ...
    it { expect(File.exist?("#{@assets_css}/views/other_name.scss")).to eq(true) }
    it { expect(File.exist?("#{@assets_js}/views/other_name.js")).to eq(true) }
